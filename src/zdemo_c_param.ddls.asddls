...
define root view entity zdemo_c_param as projection on zdemo_i_param
{
    ...
    { id: 'Results',     purpose: #STANDARD, position: 20, label:  'Results',  type:   #LINEITEM_REFERENCE,  targetElement: '_outputs' } ]
 ...
 @UI.hidden: true
   ...
   @UI.identification: [{position: 20, label: 'Integer1'}]
    ...
    Op as Op,
    _outputs: redirected to composition child z_c_class_output
}
